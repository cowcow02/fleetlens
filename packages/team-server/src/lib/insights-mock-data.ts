...
export const mockTeamInsightReport: TeamInsightReport = {
  ...
  variants: {
    ...
    v5_extras: {
      ...
      // v5.2 — action-first manager dashboard
      actionables: {
        hero_takeaway:
          "Throughput is up 12% but review time is up 22% — the team's bottleneck moved from writing code to reviewing it. Three actions below address it; six more lean into what's working and watch what's not.",
        strengths: [
          {
          ...
          {
            observation: "Plan-mode adoption climbing four weeks running",
            metric: "Plan-mode adopters: 1 → 2 → 3 → 3 over 4 weeks; longest discipline streak now 4 days",
            action: "Reach out to Bob (the only non-adopter on active work) with a 5-min pairing session before Wednesday's migration.",
          },
        ],
        dysfunctions: [
          {
            observation: "Bob ran three back-to-back late-night sessions",
            metric: "3 sessions started after 22:00 on Tue/Wed/Thu, all > 2h",
            action: "Workload conversation in next 1:1 — frame as wellbeing, not productivity. The 4.2h Wednesday migration was load-bearing for the team; check if the timing was Bob's choice or a deadline pressure.",
          },
          {
            observation: "Agent failed the same team standards across multiple members",
            metric: "4 unique conformity rules tripped; `test:must-cover-error-path` failed in 2 separate members' sessions",
        ...
        risk_signals: [
          {
            name: "Babysitting risk",
            current_value: "9 of 38 sessions (24%) classified as heavy-steering",
            level: "yellow",
            threshold_note: "Green < 15% · Yellow 15–25% · Red > 25%. Heavy-steering = ≥10 short user turns after the initial agent work.",
            trend_4w: [38, 31, 28, 24],
            action: "Watch Bob's Thursday-style sessions specifically. Heavy steering is acceptable for domain-knowledge debugging; it's a risk when the team's harness should have covered it. If the trend rises again, escalate to a harness-investment retro.",
          },
          {
            name: "Expertise gap risk",
            current_value: "4 conformity failures + 1 yellow-CI session + median skill-required at 4/5",
            level: "yellow",
            threshold_note: "Green = 0 conformity failures · Yellow = 1–5 · Red > 5 or any prod incident from agent code. Skill-required median ≥ 4 sustained for 2+ weeks is a separate amber.",
            trend_4w: [2, 3, 5, 4],
            action: "Conformity skill (above) addresses 4 of the 5 yellow signals. The yellow-CI session was Bob's Thursday — investigate root cause; if it's recoverable via skill, author one.",
          },
          {
            name: "Wrong-tool risk",
            current_value: "3 mid-session corrective skill loads; 1 new meta-skill authored in response",
            level: "green",
            threshold_note: "Green ≤ 5 corrective loads · Yellow 6–10 · Red > 10 or any session aborted from wrong-tool-loaded.",
            trend_4w: [6, 5, 4, 3],
            action: "Trend is improving — spec-frame-loader is helping. Continue monitoring. If trend reverses, surface as candidate for another auto-loader skill.",
          },
        ],
        bottleneck_callout: {
        ...
        paired_metrics: [
          {
            speed: { label: "Lead time (median first-user → merge)", value: "142 min", delta: "−22%", delta_class: "positive" },
            quality: { label: "Conformity rate", value: "84%", delta: "+6pp", delta_class: "positive" },
            honest_read: "Both directions favourable — speed up, conformity up. The harness investment is paying off without sacrificing standards adherence.",
          },
          {
            speed: { label: "PRs shipped", value: "6", delta: "+2 PRs", delta_class: "positive" },
            quality: { label: "Rework PR rate (<24h follow-up)", value: "11%", delta: "−3pp", delta_class: "positive" },
            honest_read: "More PRs AND lower rework rate. The throughput-vs-instability paradox doesn't apply this week; usually it's one-or-the-other.",
          },
          {
            speed: { label: "Deployment frequency", value: "1.7/day", delta: "+22%", delta_class: "positive" },
            quality: { label: "Change failure rate", value: "6%", delta: "(AI 5% · human 8%)", delta_class: "" },
            honest_read: "More deploys, slightly lower CFR than the team average. AI-assisted PRs failed less than human-authored this week — counterintuitive but real.",
          },
          {
            speed: { label: "Tickets resolved", value: "7", delta: "+2 tickets", delta_class: "positive" },
            quality: { label: "14-day code churn", value: "7%", delta: "−2pp", delta_class: "positive" },
            honest_read: "More tickets, less code being reverted within 14 days. The strongest paired signal that this week's gains are real, not borrowed-from-future.",
          },
        ],
        investments: [
          {
            title: "Author a `team-standards-check` skill",
            rationale: "Conformity failures cluster on the same rules across members. A pre-load skill that names the team's standards would catch these before commit, where they're cheap.",
            evidence: "4 unique rules tripped; `test:must-cover-error-path` tripped in 2 different members' sessions.",
            effort: "small",
          },
          {
          ...
          {
            title: "Add review-depth tracking to CI",
            rationale: "Review time grew 22% this week — the team's new bottleneck. Tracking human comments per agent-PR over weeks will tell us if review depth is increasing (healthy oversight) or decreasing (rubber-stamping).",
            evidence: "Current week: 3.4 comments per agent-PR, up 18% WoW. Worth a sustained trend before acting.",
            effort: "medium",
          },
          {
            title: "Try a `writing-docs` agent session next week",
            rationale: "Docs is the only DORA use case the team didn't touch this week (0 sessions, 0 hours). The harness covers it well; the team hasn't tried.",
            evidence: "CLAUDE.md got 2 manual additions this week; both could have been agent-drafted from session content.",
            effort: "small",
          },
        ],
        oneonone_prompts: [
          {
            member: "Bob",
            prompt: "Late-night sessions × 3 — was the timing a deadline thing or your preference? Anything we can lift off your plate before next week's migration?",
            evidence: "Tue/Wed/Thu sessions started >22:00, all > 2h",
          },
          {
            member: "Bob",
          ...
          {
            member: "Dana",
            prompt: "Three weeks in, first subagent dispatch this week. How's the ramp feeling? Anything blocking you from the next milestone (first PR)?",
            evidence: "First subagent dispatch (Explore) on Friday; no PRs yet",
          },
        ],
        demo_candidates: [
          {
            session_label: "Alice · Tue · topeka · 47-min parallel ship",
            member: "Alice",
        ...
        appendix_note:
          "The data substrate is in the appendix below: full pipeline phase table, DORA-with-attribution detail, output quality detail, ticket lifecycle, case-study attribution, and cost per resolved ticket. Use these when you want to dig past the actionable summaries.",
      },
    },

    // ─── v6: Ticket lifecycle spine + telemetry overlay ───────────────────
    v6_extras: {
      headline:
        "The strongest story is not 'the team used agents more.' It is: the implementation window compressed, and the bottleneck moved downstream into review and QA.",
      premise:
        "Ticket systems already hold the live journey: status changes, assignee changes, PR links, release markers, and timestamps. Codex JSONL adds the human-agent work inside each phase. Opted-in session sections explain why a ticket moved quickly, stalled, or changed shape.",
      universal_workflow_note:
        "This prototype assumes an Acme workflow: To write spec → Ready for development → Pending code review → Ready for QA → QA done, ready to launch. In production, Fleetlens would infer or let the team confirm a mapping from each Linear/Jira/custom status into normalized phases before showing phase metrics.",
      workflow_mappings: [
        {
          source: "Linear",
          raw_status: "To write spec",
          normalized_phase: "spec",
          confidence: "high",
          note: "Custom Started-category status; first phase with assignee activity.",
        },
        {
          source: "Linear",
          raw_status: "Ready for development",
          normalized_phase: "ready",
          confidence: "high",
          note: "Queue time before a coding session starts; usually zero agent time.",
        },
        {
          source: "Linear",
          raw_status: "In progress / Implementing",
          normalized_phase: "implementation",
          confidence: "high",
          note: "Mapped to JSONL active segments, commits, and PR creation.",
        },
        {
          source: "Linear",
          raw_status: "Pending code review",
          normalized_phase: "code-review",
          confidence: "high",
          note: "PR opened to review approval, with review comments and rework commits.",
        },
        {
          source: "Jira",
          raw_status: "Ready for QA / QA in progress",
          normalized_phase: "qa",
          confidence: "medium",
          note: "Status names differ by board; changelog timestamps still give phase spans.",
        },
        {
          source: "Custom",
          raw_status: "QA done, ready to launch / Released",
          normalized_phase: "launch",
          confidence: "needs-review",
          note: "Needs project-specific confirmation because some teams mark Done at merge, others at production.",
        },
      ],
      phase_summaries: [
        {
        ...
        },
        {
          ...
          bottleneck_score: 18,
          narrative:
            "Queue time is low. This is mostly calendar handoff, not a Codex usage problem.",
        },
        {
          phase: "implementation",
          label: "Implementation",
          median_min: 68,
          previous_median_min: 183,
          delta_pct: -63,
          ticket_count: 7,
          agent_time_min: 642,
          submitted_sections: 9,
          bottleneck_score: 35,
          narrative:
            "The implementation window compressed dramatically. The report should now explain which agent patterns made that happen.",
        },
        {
          phase: "code-review",
          label: "Pending code review",
          median_min: 128,
          previous_median_min: 89,
          delta_pct: 44,
          ticket_count: 6,
          agent_time_min: 74,
          submitted_sections: 5,
          bottleneck_score: 86,
          narrative:
            "Review is now the widest phase. Agent work moved faster than human review and QA throughput.",
        },
        {
          phase: "qa",
          label: "Ready for QA",
          median_min: 94,
          previous_median_min: 71,
          delta_pct: 32,
          ticket_count: 5,
          agent_time_min: 43,
          submitted_sections: 2,
          bottleneck_score: 71,
          narrative:
            "QA grew because more work reached it. This is a downstream pressure signal, not necessarily a quality decline.",
        },
        {
          phase: "launch",
          label: "QA done, ready to launch",
          median_min: 37,
          previous_median_min: 62,
          delta_pct: -40,
          ticket_count: 4,
          agent_time_min: 21,
          ...
          bottleneck_score: 24,
          narrative:
            "Launch wait is healthy this week; release automation is absorbing the final handoff.",
        },
      ],
      ticket_journeys: [
        {
          ...
          outcome: "launched",
          total_min: 593,
          delta_vs_prior_pct: -31,
          implementation_window_min: 74,
          previous_implementation_window_min: 244,
          insight:
            "The ticket did not become faster because it was simple. It became faster because Bob converted migration risk into a guarded autonomous run, then spent the rest of the lifecycle waiting on review and QA.",
          phase_spans: [
            {
              phase: "spec",
              label: "To write spec",
              start: "2026-05-06T09:18:00",
              end: "2026-05-06T10:12:00",
              duration_min: 54,
              agent_time_min: 18,
              submitted_sections: [
                {
                  timestamp: "2026-05-06T09:42:00",
                  member: "Bob",
                  label: "Risk inventory excerpt submitted",
                  sensitivity: "opt-in",
                },
              ],
            },
            {
              phase: "ready",
              label: "Ready for development",
              start: "2026-05-06T10:12:00",
              end: "2026-05-06T10:35:00",
              duration_min: 23,
              agent_time_min: 0,
              submitted_sections: [],
            },
            {
              phase: "implementation",
              label: "Implementation",
              start: "2026-05-06T10:35:00",
              end: "2026-05-06T11:49:00",
              duration_min: 74,
              agent_time_min: 252,
              submitted_sections: [
                {
                ...
                {
                  timestamp: "2026-05-06T11:36:00",
                  member: "Bob",
                  label: "Autonomous run summary",
                  sensitivity: "opt-in",
                },
              ],
            },
            {
              phase: "code-review",
              label: "Pending code review",
              start: "2026-05-06T11:49:00",
              end: "2026-05-06T14:32:00",
              duration_min: 163,
              agent_time_min: 31,
              submitted_sections: [
                {
                  timestamp: "2026-05-06T13:14:00",
                  member: "Bob",
                  label: "Reviewer follow-up handled by agent",
                  sensitivity: "opt-in",
                },
              ],
            },
            {
              phase: "qa",
              label: "Ready for QA",
              start: "2026-05-06T14:32:00",
              end: "2026-05-06T17:51:00",
              duration_min: 199,
              agent_time_min: 12,
              submitted_sections: [],
            },
            {
              phase: "launch",
              label: "QA done, ready to launch",
              start: "2026-05-06T17:51:00",
              end: "2026-05-06T19:11:00",
              duration_min: 80,
              agent_time_min: 8,
              submitted_sections: [],
            },
        ...
        },
        {
          ...
          outcome: "launched",
          total_min: 178,
          delta_vs_prior_pct: -67,
          implementation_window_min: 47,
          previous_implementation_window_min: 138,
          insight:
            "Alice's ticket is the clearest version of the shrinking implementation window: a contract brief turned four workers into one coherent first-pass PR, so the rest of the lifecycle was mostly validation.",
          phase_spans: [
            {
              phase: "spec",
              label: "To write spec",
              start: "2026-05-05T13:10:00",
              end: "2026-05-05T13:29:00",
              duration_min: 19,
              agent_time_min: 14,
              submitted_sections: [
                {
                  timestamp: "2026-05-05T13:17:00",
                  member: "Alice",
                  label: "Brief-as-contract submitted",
                  sensitivity: "opt-in",
                },
              ],
            },
            {
              phase: "ready",
              label: "Ready for development",
              start: "2026-05-05T13:29:00",
              end: "2026-05-05T13:34:00",
              duration_min: 5,
              agent_time_min: 0,
              submitted_sections: [],
            },
            {
              phase: "implementation",
              label: "Implementation",
              start: "2026-05-05T13:34:00",
              end: "2026-05-05T14:21:00",
              duration_min: 47,
              agent_time_min: 48,
              submitted_sections: [
                {
                  timestamp: "2026-05-05T13:52:00",
                  member: "Alice",
                  label: "4-worker parallel dispatch",
                  sensitivity: "opt-in",
                },
              ],
            },
            {
              phase: "code-review",
              label: "Pending code review",
              start: "2026-05-05T14:21:00",
              end: "2026-05-05T15:08:00",
              duration_min: 47,
              agent_time_min: 4,
              submitted_sections: [],
            },
            {
              phase: "qa",
              label: "Ready for QA",
              start: "2026-05-05T15:08:00",
              end: "2026-05-05T15:47:00",
              duration_min: 39,
              agent_time_min: 0,
              submitted_sections: [],
            },
            {
              phase: "launch",
              label: "QA done, ready to launch",
              start: "2026-05-05T15:47:00",
              end: "2026-05-05T16:08:00",
              duration_min: 21,
              agent_time_min: 0,
              submitted_sections: [],
            },
        ...
        },
        {
          ...
          outcome: "qa-ready",
          total_min: 443,
          delta_vs_prior_pct: 18,
          implementation_window_min: 142,
          previous_implementation_window_min: 96,
          insight:
            "This is the counterexample. Implementation did not shrink because the ticket entered a domain-debug phase the harness did not cover; the submitted section explains the rapid-fire human steering tail.",
          phase_spans: [
            {
              phase: "spec",
              label: "To write spec",
              start: "2026-05-07T08:58:00",
              end: "2026-05-07T09:34:00",
              duration_min: 36,
              agent_time_min: 9,
              submitted_sections: [],
            },
            {
              phase: "ready",
              label: "Ready for development",
              start: "2026-05-07T09:34:00",
              end: "2026-05-07T10:01:00",
              duration_min: 27,
              agent_time_min: 0,
              submitted_sections: [],
            },
            {
              phase: "implementation",
              label: "Implementation",
              start: "2026-05-07T10:01:00",
              end: "2026-05-07T12:23:00",
              duration_min: 142,
              agent_time_min: 101,
              submitted_sections: [
                {
                  timestamp: "2026-05-07T10:29:00",
                  member: "Bob",
                  label: "Initial diagnosis",
                  sensitivity: "opt-in",
                },
                {
                  timestamp: "2026-05-07T11:46:00",
                  member: "Bob",
                  label: "Rapid-fire steering tail",
                  sensitivity: "opt-in",
                },
              ],
            },
            {
              phase: "code-review",
              label: "Pending code review",
              start: "2026-05-07T12:23:00",
              end: "2026-05-07T15:48:00",
              duration_min: 205,
              agent_time_min: 39,
              submitted_sections: [
                {
                  timestamp: "2026-05-07T14:11:00",
                  member: "Bob",
                  label: "Yellow CI follow-up",
                  sensitivity: "tier-1",
                },
              ],
            },
            {
              phase: "qa",
              label: "Ready for QA",
              start: "2026-05-07T15:48:00",
              end: "2026-05-07T16:21:00",
              duration_min: 33,
              agent_time_min: 0,
              submitted_sections: [],
            },
      ...
      implementation_trend: [
        { period: "4 wks ago", median_implementation_min: 214, median_total_min: 612, review_qa_share_pct: 28 },
        { period: "3 wks ago", median_implementation_min: 176, median_total_min: 544, review_qa_share_pct: 34 },
        { period: "2 wks ago", median_implementation_min: 121, median_total_min: 411, review_qa_share_pct: 43 },
        { period: "Last wk", median_implementation_min: 183, median_total_min: 476, review_qa_share_pct: 37 },
        { period: "This wk", median_implementation_min: 68, median_total_min: 442, review_qa_share_pct: 50 },
      ],
      allocation: [
        {
          member: "Alice",
          spec_min: 46,
          implementation_min: 104,
          review_min: 21,
          qa_min: 0,
          launch_min: 0,
          dominant_phase: "implementation",
          note: "Short implementation windows; high leverage from orchestration.",
        },
        {
          member: "Bob",
          spec_min: 49,
          implementation_min: 353,
          review_min: 70,
          qa_min: 12,
          launch_min: 8,
          dominant_phase: "implementation",
        ...
        },
        {
          ...
          launch_min: 0,
          dominant_phase: "spec",
          note: "Most upstream work; reviewer-triad shifts discovery left.",
        },
        {
          member: "Dana",
          spec_min: 18,
          implementation_min: 39,
          review_min: 0,
          qa_min: 0,
          launch_min: 0,
          dominant_phase: "implementation",
          note: "Early ramp; telemetry useful for onboarding but not yet enough for bottleneck inference.",
        },
      ],
      case_studies: [
        {
          ...
          phase: "implementation",
          evidence_level: "opt-in-session",
          what_happened:
            "Alice submitted the orchestration brief and the parallel worker summary. The team report can show that the spec/brief phase was not overhead; it is what made the 47-minute implementation phase coherent.",
          why_it_matters:
            "This explains a ticket-level number with a session-level mechanism. Without the opt-in section, the ticket only says implementation was short; with it, the team learns how to reproduce it.",
        },
        {
          ...
          evidence_level: "opt-in-session",
          what_happened:
            "Bob's submitted session shows the guard skill catching two unsafe migration operations before PR open. The ticket later moved through review and QA without rework.",
          why_it_matters:
            "This is the manager story: longer autonomous runs can be safe when the harness turns risky checks into explicit gates.",
        },
        {
        ...
        },
        {
          ...
          evidence_level: "opt-in-session",
          what_happened:
            "The ticket entered a debug phase where the agent needed short, high-context human corrections after the initial diagnosis.",
          why_it_matters:
            "This is the negative case study. The report should not just celebrate compression; it should identify the missing harness shape for domain-debug work.",
        },
      ],
      answerable_questions: [
        {
          question: "Where did the ticket actually spend time?",
          data_needed: "Ticket status changelog timestamps, normalized into team-specific workflow phases.",
          answer_if_connected: "This week: implementation median 68m, code review 128m, QA 94m. The bottleneck moved out of coding.",
        ...
        {
          question: "Can this work for Jira and Linear?",
          data_needed: "A per-project workflow map from raw statuses into normalized phases, reviewed by the team once.",
          answer_if_connected: "Yes for timing and phase distribution; richer live-story cards depend on PR/deploy linkage and opt-in session content.",
          capturability: "needs-workflow-mapping",
        },
      ],
    },
